...
> **Phiên bản tài liệu:** 0.6.1
> **Trạng thái:** Bản checkpoint chuẩn hóa từ 0.6.0
> **Ngày tạo:** 2026-06-26
...
Tài liệu này đặc tả yêu cầu phần mềm cho hệ thống chống trộm IoT dùng Arduino Cloud, ESP32-CAM hoặc board tương đương, cảm biến chuyển động/khoảng cách/ánh sáng, còi, LED, notification và dashboard theo vai trò.

Bản chuẩn hóa này giữ nguyên phạm vi nghiệp vụ của checkpoint 0.6.0: tập trung vào chống trộm cho một khu vực giám sát hiện tại là phòng bếp; không đưa lại báo cháy, Flame Sensor, đo nhiệt độ bếp hoặc RFID-RC522 vào phạm vi chính. Các thay đổi trong bản 0.6.1 chỉ nhằm chuẩn hóa cấu trúc, ngôn ngữ, heading, metadata và cách trình bày.
...
| Trạng thái hiện tại | Bản checkpoint 0.6.1; đã chuẩn hóa cấu trúc và cách trình bày, không thay đổi nội dung yêu cầu so với checkpoint 0.6.0 |
