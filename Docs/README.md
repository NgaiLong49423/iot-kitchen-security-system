...
| 2   | ESP32-CAM Module Wifi ESP32 Camera OV3660 | Vi điều khiển chính của hệ thống, xử lý dữ liệu cảm biến, kết nối WiFi, gửi cảnh báo lên Internet và chụp ảnh hiện trường khi phát hiện xâm nhập.                                                                                                                                  |
