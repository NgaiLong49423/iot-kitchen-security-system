...
| 7   | HC-SR501                                | Phát hiện chuyển động của con người dựa trên bức xạ hồng ngoại từ cơ thể. Là cảm biến chính dùng để nhận diện sự xuất hiện của người trong khu vực giám sát.                                                                                                                       |
