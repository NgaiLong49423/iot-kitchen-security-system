...
> **Trạng thái:** Bản checkpoint cập nhật board chính sang Freenove ESP32-S3 WROOM + Camera OV3660
> **Ngày tạo:** 2026-06-26
...
| HY-SRF05 ultrasonic sensor | Đo khoảng cách vật thể |
...
9. Board `Freenove ESP32-S3 WROOM + Camera OV3660` được xem là phần cứng chính cho bản triển khai hiện tại; nếu đổi sang biến thể ESP32-S3 WROOM/ESP32-S3 CAM khác, cần kiểm tra lại camera sensor, pinout và cấu hình nạp code trước khi code.
