...
> **Trạng thái tài liệu:** Bản checkpoint cập nhật 0.6.0  
...
| Trạng thái hiện tại | Bản checkpoint 0.6.0; đã cập nhật các quyết định sau rà soát mâu thuẫn, gồm Alarm Status Priority, Global Reset, Telegram/SOS Email Separation, Google Apps Script Polling, Notification Request Auto Reset, Camera Manual/Auto Capture Separation, LED xanh trạng thái bình thường, LED đỏ nháy nội bộ, Cooldown Display, Anti-Sabotage 5 giây và Intrusion Score Pipeline|
...
| ESP32-CAM camera | Hệ thống phải hỗ trợ chụp ảnh tự động cho đột nhập và chụp thủ công từ dashboard. |
...
Khi một `intrusion_alert` mới được kích hoạt, hệ thống phải tự động kích hoạt chụp ảnh bằng ESP32-CAM.
...
## BR-51. SOS Simplified Demo Rule
...
## BR-52. SOS Button Auto Reset Rule
...
## BR-53. Email-Based SOS Escalation Confirmation Rule
...
## BR-55. Simple Event Logging Rule
...
## BR-56. Simple Notification Cooldown Rule
...
## BR-58. Simple Notification Status Rule
...
## BR-59. Emergency Escalation Status Rule
...
## BR-60. Google Apps Script Emergency Flow Rule
...
## BR-61. Minimal Dashboard Scope Rule
...
## BR-62. Simple Camera Failure Rule
...
## BR-63. Demo Acceptance Test Rule
...
## BR-64. Alarm Status Priority Rule
...
## BR-66. Separation Between Telegram Notification And SOS Email Escalation Rule
...
## BR-67. Google Apps Script SOS Polling Rule

Trong phiên bản demo, ESP32/board dùng cơ chế polling để kiểm tra trạng thái xác nhận SOS từ Google Apps Script.
...
## BR-68. SOS Confirmation Polling Timeout Rule
...
Sau khi SOS xảy ra và hệ thống đặt `emergency_escalation_status = WAITING_CONFIRMATION`, ESP32 phải gọi Google Apps Script mỗi 5 giây để kiểm tra trạng thái xác nhận.
...
## BR-69. Emergency Authority Contact Configuration Rule
...
## BR-70. Notification Request Auto Reset Rule
...
## BR-71. Latest Notification Status Rule
...
## BR-72. Manual And Automatic Photo Capture Separation Rule
...
## BR-73. Simple Photo Status Rule
...
## BR-74. Notification Cooldown Display Rule
...
## BR-75. Device Tampered Intermediate State Rule
...
## BR-76. Anti-Sabotage Object Near Duration Rule
...
## BR-77. Intrusion Score Calculation Pipeline Rule
...
## BR-78. Night Mode Intrusion Score Rule
...
## BR-79. Event Counter Rule For Schedule Events
...
## BR-81. Normal And Alarm LED Indicator Rule
...
## BR-82. Red LED Blink Internal Rule
...
## BR-83. Automatic Photo Capture Request Display Rule
...
## BR-84. Camera Failure Notification Rule
...
## BR-85. No Camera Failure Cooldown Rule
...
## BR-86. LDR Covered Duration For Anti-Sabotage Rule
...
## BR-87. Temporary Device Tampered Hold Rule
...
6. Nếu chụp thất bại, hệ thống đặt `photo_status = "FAILED"`, cập nhật `last_event_type = "photo_capture_failed"` và gửi notification theo Camera Failure Notification Rule.
...
6. ESP32 polling Google Apps Script mỗi 5 giây để kiểm tra trạng thái xác nhận.
...
| Photo fail | Camera lỗi/chụp thất bại | `photo_status = FAILED` |
...
| Viết ESP32/Arduino code | Implementation | Đọc cảm biến, tính trạng thái, gửi notification |
...
# Kết thúc bản SRS checkpoint 0.6.0