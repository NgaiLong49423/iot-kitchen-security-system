...
> **Phiên bản tài liệu:** 0.6.5
> **Trạng thái:** Bản checkpoint cập nhật BLE nhận diện chủ nhà và SOS escalation qua Google Apps Script
> **Ngày tạo:** 2026-06-26
...
Bản 0.6.5 kế thừa phạm vi nghiệp vụ của checkpoint 0.6.4: tập trung vào chống trộm cho một khu vực giám sát hiện tại là phòng bếp; không đưa lại báo cháy, Flame Sensor, đo nhiệt độ bếp hoặc RFID-RC522 vào phạm vi chính. Thay đổi chính của bản này là bổ sung cơ chế quét Bluetooth Low Energy (BLE) để nhận diện thiết bị/điện thoại đáng tin của chủ nhà, đồng thời mở rộng luồng SOS qua Google Apps Script để gửi địa chỉ nhà và ghi chú bổ sung đến contact cơ quan chức năng/công an được cấu hình hợp lệ sau khi Parent/Admin xác nhận.
...
| Trạng thái hiện tại | Bản checkpoint 0.6.5; giữ board chính `Freenove ESP32-S3 WROOM + Camera OV3660`, bổ sung BLE trusted device scanning và cập nhật luồng SOS authority escalation qua Google Apps Script |
